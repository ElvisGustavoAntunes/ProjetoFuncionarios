...
<html lang="pt-br">
  ...
  <body>
    ...
    ?>
        ...
        <tbody>
            <?php
            while($row_pessoa = mysqli_fetch_assoc($resultado_usuario)) {
                ?>
                <tr>
                    <th><?php echo $row_pessoa['id']; ?></th>
                    <td><?php echo $row_pessoa['nome']; ?></td>
                    <td><?php echo $row_pessoa['sobrenome']; ?></td>
                    <td><?php echo $row_pessoa['cpf']; ?></td>
                    <td><?php echo $row_pessoa['datanascimento']; ?></td>
                    <td><?php echo $row_pessoa['empresa']; ?></td>
                    <td><?php echo $row_pessoa['salario']; ?></td>
                    <td><?php echo $row_pessoa['data_hora']; ?></td>
                    <td><?php echo "<a href='apaga.php?id=".$row_pessoa['id']."'>Excluir</a>"?> </td>
                </tr>
                <?php
            }?>  
        </tbody>
